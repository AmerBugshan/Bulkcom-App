...
import 'package:fundorex/model/country_dropdown_model.dart';
...
//==============================>
  ...
  fetchCountries(BuildContext context) async {
    if (countryDropdownList.isEmpty) {
      ...
      var response = await http.get(Uri.parse('$baseApi/country-list'));
  ...
  setCountry(BuildContext context, {data}) {
    ...
    if (profileData != null && profileData.country?.name != null) {
